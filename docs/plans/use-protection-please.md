...
| H-16 | ★ `unsafe` isolated, SAFETY-commented, inventoried | Incomplete | See per-unit evidence. | |
...
| H-19 | Input validation — external bytes treated as hostile | Incomplete | See per-unit evidence. | |
...
|---|---|---|---|---|---|
| 2026-09-07 | deep | Claude (use-protection-please v1, depth=deep) | 2 / 0 / 32 | 0 of 15 | First pass. Zero `Scheduled` by design: scheduling needs an owner and a date, which are the human's to assign, not the auditor's. |
|---|---|---|---|---|---|
